 ...
 */
typedef bool (*nanocbor_encoder_fits)(nanocbor_encoder_t *enc, void *ctx,
                                      size_t len);
 ...
 */
typedef void (*nanocbor_encoder_append)(nanocbor_encoder_t *enc, void *ctx,
...
/**
 * @brief Retrieve the number of remaining values in a CBOR container: either
 * array or map
 *
