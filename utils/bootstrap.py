...
dependencies = {
    ...
    'firmware-coreonel_ac_controller': {
        'version': '0.0.3',
        'url': 'https://prusa-buddy-firmware-dependencies.s3.eu-central-1.amazonaws.com/firmware-coreonel_ac_controller-0.0.3-E218A851-A97E-4608-9335-B0309333B5FC.zip',
    },
    'firmware-mmu': {
        'version': '3.0.3',
        'files': [
