...
#if HAS_NOZZLE_CLEANING_FAILED_PURGING()
    FrameDefinition<Phase::recommend_purge, WithFooter<FramePrompt, nozzle_cleaning_footer_items>, Phase::recommend_purge, txt_title_cleaning_nozzle, txt_desc_recommend_purge>,
    FrameDefinition<Phase::wait_temp, WithFooter<FrameNozzleCleaningProgress, nozzle_cleaning_footer_items>, Phase::wait_temp, txt_title_cleaning_nozzle, txt_desc_wait_temp>,
    FrameDefinition<Phase::purge, WithFooter<FrameNozzleCleaningProgress, nozzle_cleaning_footer_items>, Phase::purge, txt_title_cleaning_nozzle, txt_desc_purge>,
    FrameDefinition<Phase::autoretract, WithFooter<FrameNozzleCleaningProgress, nozzle_cleaning_footer_items>, Phase::autoretract, txt_title_cleaning_nozzle, txt_desc_autoretract>,
    FrameDefinition<Phase::remove_filament, WithFooter<FramePrompt, nozzle_cleaning_footer_items>, Phase::remove_filament, txt_title_cleaning_nozzle, txt_desc_remove_filament>,
#endif
#if HAS_AUTO_RETRACT()
    FrameDefinition<Phase::offer_auto_retract_enable, FramePrompt, Phase::offer_auto_retract_enable, txt_desc_cleaning_failed, txt_desc_offer_auto_retract>,
#endif
    FrameDefinition<Phase::warn_abort, WithFooter<FramePrompt, nozzle_cleaning_footer_items>, Phase::warn_abort, txt_warning, txt_desc_warn_abort>>;
